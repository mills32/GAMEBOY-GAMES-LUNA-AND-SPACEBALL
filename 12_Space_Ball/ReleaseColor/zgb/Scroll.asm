...
;C:/gbdk/ZGB/common/src/Scroll.c:45: unsigned char* pending_w_map = 0;
	...
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:47: unsigned char* pending_h_cmap = 0;
	ld	hl,#_pending_h_cmap
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:48: unsigned char* pending_w_cmap = 0;
...
;C:/gbdk/ZGB/common/src/Scroll.c:174: UINT8 clamp_enabled = 1;
	...
	ld	(hl),#0x01
;C:/gbdk/ZGB/common/src/Scroll.c:451: UINT16 ParaOffset = 0;
	ld	hl,#_ParaOffset
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:457: UINT8 Parallax_Columns = 4;
	ld	hl,#_Parallax_Columns
	ld	(hl),#0x04
;C:/gbdk/ZGB/common/src/Scroll.c:461: unsigned char *Para_Tiles = 0;
	ld	hl,#_Para_Tiles
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:462: UINT8 STAT	= 0x41;
	ld	hl,#_STAT
	ld	(hl),#0x41
;--------------------------------------------------------
; Home
...
;C:/gbdk/ZGB/common/src/Scroll.c:100: UINT8 replacement = *t;
	...
	ldhl	sp,#3
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:108: UINT8 color_map = *c;
	ldhl	sp,#(20 - 1)
	ld	c,(hl)
	inc	hl
	ld	b,(hl)
...
;C:/gbdk/ZGB/common/src/Scroll.c:138: ZGB_SET_TILE( x, y, replacement);
	...
	add	sp, #3
	pop	bc
;C:/gbdk/ZGB/common/src/Scroll.c:140: VBK_REG = 1;
	ld	hl,#0xff4f
	ld	(hl),#0x01
;C:/gbdk/ZGB/common/src/Scroll.c:141: ZGB_SET_TILE( x, y, color_map);
	ldhl	sp,#0
	ld	a,(hl)
	push	af
	inc	sp
	...
	call	_ZGB_SET_TILE
	add	sp, #3
;C:/gbdk/ZGB/common/src/Scroll.c:142: VBK_REG = 0;
	ld	hl,#0xff4f
	ld	(hl),#0x00
	add	sp, #11
	ret
...
;C:/gbdk/ZGB/common/src/Scroll.c:160: set_win_tiles(x, y, w, h, map);
	...
	call	_set_win_tiles
	add	sp, #6
;C:/gbdk/ZGB/common/src/Scroll.c:163: if(cmap) {
	ldhl	sp,#10
	ld	a,(hl-)
	or	a,(hl)
	jp	Z,_PopBank
;C:/gbdk/ZGB/common/src/Scroll.c:164: VBK_REG = 1;
	ld	hl,#0xff4f
	ld	(hl),#0x01
;C:/gbdk/ZGB/common/src/Scroll.c:165: set_win_tiles(x, y, w, h, cmap);
	ldhl	sp,#9
	ld	a,(hl+)
	ld	h,(hl)
	ld	l,a
	...
	call	_set_win_tiles
	add	sp, #6
;C:/gbdk/ZGB/common/src/Scroll.c:166: VBK_REG = 0;
	ld	hl,#0xff4f
	ld	(hl),#0x00
...
;C:/gbdk/ZGB/common/src/Scroll.c:195: scroll_map = map;
	...
	ld	(hl),a
	pop	hl
;C:/gbdk/ZGB/common/src/Scroll.c:197: scroll_cmap = cmap;
	push	hl
	ldhl	sp,#13
	ld	a,(hl)
	ld	hl,#_scroll_cmap
...
00104$:
	...
	or	a, a
	jp	Z,00106$
;C:/gbdk/ZGB/common/src/Scroll.c:248: UPDATE_TILE(pending_w_x ++, pending_w_y, pending_w_map ++, pending_w_cmap++);
	ld	hl,#_pending_w_cmap
	ld	a,(hl+)
	ld	e, (hl)
	ldhl	sp,#3
...
;C:/gbdk/ZGB/common/src/Scroll.c:263: pending_w_map = scroll_map + scroll_tiles_w * y + x;
	...
	ld	(hl+),a
	ld	(hl),d
;C:/gbdk/ZGB/common/src/Scroll.c:266: pending_w_cmap = scroll_cmap + scroll_tiles_w * y + x;
	pop	de
	push	de
	ld	hl,#_scroll_cmap
	ld	a,(hl+)
...
;C:/gbdk/ZGB/common/src/Scroll.c:272: unsigned char* map = scroll_map + scroll_tiles_w * y + x;
	...
	inc	sp
	push	bc
;C:/gbdk/ZGB/common/src/Scroll.c:275: unsigned char* cmap = scroll_cmap + scroll_tiles_w * y + x;
	ldhl	sp,#(10 - 1)
	ld	e,(hl)
	inc	hl
	ld	d,(hl)
...
;C:/gbdk/ZGB/common/src/Scroll.c:279: for(i = 0u; i != SCREEN_TILE_REFRES_W; ++i) {
	...
	ld	(hl),#0x00
00102$:
;C:/gbdk/ZGB/common/src/Scroll.c:281: UPDATE_TILE(x + i, y, map ++, cmap ++);
	ldhl	sp,#9
	ld	a,(hl+)
	ld	e, (hl)
	ldhl	sp,#3
...
00104$:
	...
	or	a, a
	jp	Z,00106$
;C:/gbdk/ZGB/common/src/Scroll.c:294: UPDATE_TILE(pending_h_x, pending_h_y ++, pending_h_map, pending_h_cmap);
...
00122$:
	...
	call	_UPDATE_TILE
	add	sp, #8
;C:/gbdk/ZGB/common/src/Scroll.c:295: pending_h_map += scroll_tiles_w;
	ld	hl,#_pending_h_map
	ld	a,(hl)
	ld	hl,#_scroll_tiles_w
	add	a, (hl)
	...
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:296: pending_h_cmap += scroll_tiles_w;
	ld	hl,#_pending_h_cmap
	ld	a,(hl)
	ld	hl,#_scroll_tiles_w
	add	a, (hl)
...
;C:/gbdk/ZGB/common/src/Scroll.c:312: pending_h_map = scroll_map + scroll_tiles_w * y + x;
	...
	ld	(hl+),a
	ld	(hl),d
;C:/gbdk/ZGB/common/src/Scroll.c:315: pending_h_cmap = scroll_cmap + scroll_tiles_w * y + x;
	pop	de
	push	de
	ld	hl,#_scroll_cmap
	ld	a,(hl+)
...
;C:/gbdk/ZGB/common/src/Scroll.c:321: unsigned char* map = &scroll_map[scroll_tiles_w * y + x];
	...
	ld	(hl+),a
	ld	(hl),d
;C:/gbdk/ZGB/common/src/Scroll.c:323: unsigned char* cmap = &scroll_cmap[scroll_tiles_w * y + x];
	ld	a,c
	ld	hl,#_scroll_cmap
	add	a, (hl)
	ld	c,a
...
;C:/gbdk/ZGB/common/src/Scroll.c:327: for(i = 0u; i != SCREEN_TILE_REFRES_H; ++i) {
	...
	ld	(hl),#0x00
00102$:
;C:/gbdk/ZGB/common/src/Scroll.c:329: UPDATE_TILE(x, y + i, map, cmap);
	ldhl	sp,#4
	ld	c,(hl)
	ld	b,#0x00
	ldhl	sp,#11
	...
	call	_UPDATE_TILE
	add	sp, #8
;C:/gbdk/ZGB/common/src/Scroll.c:330: map += scroll_tiles_w;
	ldhl	sp,#(3 - 1)
	ld	e,(hl)
	inc	hl
	ld	d,(hl)
	...
	ld	(hl+),a
	ld	(hl),d
;C:/gbdk/ZGB/common/src/Scroll.c:331: cmap += scroll_tiles_w;
	pop	de
	push	de
	ld	hl,#_scroll_tiles_w
	ld	a,(hl+)
...
;C:/gbdk/ZGB/common/src/Scroll.c:439: scroll_collisions_down[tile] = col;
	...
	ld	(bc),a
	ret
;C:/gbdk/ZGB/common/src/Scroll.c:464: void DMA_TRANSFER(UINT16 *source,UINT16 *destination){
;	---------------------------------
; Function DMA_TRANSFER
; ---------------------------------
_DMA_TRANSFER::
;C:/gbdk/ZGB/common/src/Scroll.c:493: __endasm;
	PUSH	BC
	LDA	HL,7(SP)
	LD	D,(HL)
	DEC	HL
	...
	LDH	(0x55),A
	POP	BC
;C:/gbdk/ZGB/common/src/Scroll.c:494: source; destination;
	ret
;C:/gbdk/ZGB/common/src/Scroll.c:497: void CPU_TRANSFER(UINT16 *source,UINT16 *destination){
;	---------------------------------
; Function CPU_TRANSFER
; ---------------------------------
_CPU_TRANSFER::
;C:/gbdk/ZGB/common/src/Scroll.c:581: __endasm;
	PUSH	BC
	LDA	HL,7(SP)
	LD	D,(HL)
	DEC	HL
	...
	LD	C,#64
	ADD	HL,BC
	LD	A,(#_Parallax_Columns)
	DEC	A
	LD	(#_Parallax_Columns),A
	JR	NZ,2$
	POP	BC
;C:/gbdk/ZGB/common/src/Scroll.c:582: source; destination;
	ret
...
; ---------------------------------
_Update_Parallax::
;C:/gbdk/ZGB/common/src/Scroll.c:591: if (Parallax == 2) {
	ld	hl,#_Parallax
	ld	a,(hl)
	sub	a, #0x02
	ret	NZ
;C:/gbdk/ZGB/common/src/Scroll.c:592: DMA_TRANSFER((UINT16*)0xD000,(UINT16*)0x8800); //Tile 129
	ld	hl,#0x8800
	push	hl
	ld	h, #0xd0
	push	hl
...
; ---------------------------------
_Set_Parallax::
;C:/gbdk/ZGB/common/src/Scroll.c:599: ParaOffsetX = 0;
	ld	hl,#_ParaOffsetX
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:600: ParaOffsetY = 0;
	ld	hl,#_ParaOffsetY
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:601: Parallax = 0;
	ld	hl,#_Parallax
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:602: PUSH_BANK(bank);
	ldhl	sp,#4
	ld	a,(hl)
	push	af
	inc	sp
	call	_PushBank
	inc	sp
;C:/gbdk/ZGB/common/src/Scroll.c:603: Para_Tiles = tiles;
	ldhl	sp,#2
	ld	a,(hl+)
	ld	e, (hl)
	ld	hl,#_Para_Tiles
	ld	(hl+),a
	ld	(hl),e
;C:/gbdk/ZGB/common/src/Scroll.c:605: CPU_TRANSFER(Para_Tiles+ParaOffsetX+ParaOffsetY,(UINT16*)0xD000); 
	dec	hl
	ld	a,(hl)
	ld	hl,#_ParaOffsetX
	add	a, (hl)
	...
	call	_CPU_TRANSFER
	add	sp, #4
;C:/gbdk/ZGB/common/src/Scroll.c:606: pbank = bank;
	push	hl
	ldhl	sp,#6
	ld	a,(hl)
	ld	hl,#_pbank
	ld	(hl),a
	pop	hl
;C:/gbdk/ZGB/common/src/Scroll.c:609: POP_BANK;
	jp	_PopBank
...
; ---------------------------------
_Move_Parallax::
;C:/gbdk/ZGB/common/src/Scroll.c:615: if (Parallax == 2){
	ld	hl,#_Parallax
	ld	a,(hl)
	sub	a, #0x02
	jp	NZ,00104$
;C:/gbdk/ZGB/common/src/Scroll.c:616: PUSH_BANK(1);
	ld	a,#0x01
	push	af
	inc	sp
	call	_PushBank
	inc	sp
;C:/gbdk/ZGB/common/src/Scroll.c:617: SX = SCX_REG;
	ld	de,#0xff43
	ld	a,(de)
	ld	hl,#_SX
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:618: ParaOffsetX = Parallax_TableX[SX]; 
	ld	c,(hl)
	ld	b,#0x00
	sla	c
	rl	b
	ld	hl,#_Parallax_TableX
	add	hl,bc
	ld	c,l
	ld	b,h
	ld	e, c
	...
	ld	a,(de)
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:619: SY = SCY_REG;
	ld	de,#0xff42
	ld	a,(de)
	ld	hl,#_SY
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:620: ParaOffsetY = Parallax_TableY[SY];
	ld	c,(hl)
	ld	b,#0x00
	sla	c
	rl	b
	ld	hl,#_Parallax_TableY
	add	hl,bc
	ld	c,l
	ld	b,h
	ld	e, c
	...
	ld	a,(de)
	ld	(hl),a
;C:/gbdk/ZGB/common/src/Scroll.c:621: POP_BANK;
	call	_PopBank
;C:/gbdk/ZGB/common/src/Scroll.c:622: PUSH_BANK(pbank);
	ld	hl,#_pbank
	ld	a,(hl)
	push	af
	inc	sp
	call	_PushBank
	inc	sp
;C:/gbdk/ZGB/common/src/Scroll.c:625: if (ParaOffset == 64) ParaOffset = 0;
	ld	hl,#_ParaOffset
	ld	a,(hl)
	sub	a, #0x40
	jr	NZ,00102$
	...
	ld	(hl),#0x00
00102$:
;C:/gbdk/ZGB/common/src/Scroll.c:626: CPU_TRANSFER(Para_Tiles+ParaOffsetX+ParaOffsetY,(UINT16*)0xD000); //Copy Tiles to VRam 
	ld	hl,#_Para_Tiles
	ld	a,(hl)
	ld	hl,#_ParaOffsetX
	add	a, (hl)
	...
	call	_CPU_TRANSFER
	add	sp, #4
;C:/gbdk/ZGB/common/src/Scroll.c:627: POP_BANK;
	call	_PopBank
;C:/gbdk/ZGB/common/src/Scroll.c:628: Parallax = 0;
	ld	hl,#_Parallax
	ld	(hl),#0x00
;C:/gbdk/ZGB/common/src/Scroll.c:629: ParaOffset+=2;
	ld	hl,#_ParaOffset
	ld	a,(hl)
	add	a, #0x02
	ld	(hl+),a
	...
	ld	(hl),a
00104$:
;C:/gbdk/ZGB/common/src/Scroll.c:631: Parallax++;
	ld	hl,#_Parallax
	inc	(hl)
	ret
	.area _CODE
