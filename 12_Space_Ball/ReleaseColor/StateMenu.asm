...
;StateMenu.c:104: InitScroll(map_menuWidth, map_menuHeight, map_menuPLN0, 0, 0, 3, map_menuPLN1);
	...
	call	_InitScroll
	add	sp, #13
;StateMenu.c:105: SpriteManagerAdd(SPRITE_ARROW, 80, 80);
	ld	hl,#0x0050
	push	hl
	ld	l, #0x50
	push	hl
	...
	add	sp, #5
;StateMenu.c:106: SpriteManagerAdd(SPRITE_ROCKET, 160+16, 3*8);
	ld	hl,#0x0018
	push	hl
	ld	l, #0xb0
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateMenu.c:107: SpriteManagerAdd(SPRITE_UFO, -16, 10*8);
	ld	hl,#0x0050
	push	hl
	ld	hl,#0xfff0
	push	hl
...
00109$:
;StateMenu.c:122: InitScroll(map_menuWidth, map_menuHeight, map_menuPLN0+(40*18), 0, 0, 3, map_menuPLN1+(40*18));
	ld	hl,#(_map_menuPLN1 + 0x02d0)
	push	hl
	ld	a,#0x03
	push	af
	inc	sp
...
;StateMenu.c:158: Menu_Mode = 3;
	ld	hl,#_Menu_Mode
	ld	(hl),#0x03
;StateMenu.c:159: SpriteManagerAdd(SPRITE_ARROW, 80, 80);
	ld	hl,#0x0050
	push	hl
	ld	l, #0x50
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateMenu.c:160: SpriteManagerAdd(SPRITE_UFO, -16, 3*8);
	ld	hl,#0x0018
	push	hl
	ld	hl,#0xfff0
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateMenu.c:161: SpriteManagerAdd(SPRITE_SHIP, 160+16, 10*8);
	ld	hl,#0x0050
	push	hl
	ld	l, #0xb0
	push	hl
