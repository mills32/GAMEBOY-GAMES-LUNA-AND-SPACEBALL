...
void Update_SPRITE_PLAYER(){
	...
	if(KEY_PRESSED(J_RIGHT)) TranslateSprite(THIS,1,0);
	if(KEY_PRESSED(J_LEFT)) TranslateSprite(THIS,-1,0);
	if(KEY_PRESSED(J_UP)) TranslateSprite(THIS,0,-1);
	if(KEY_PRESSED(J_DOWN)) TranslateSprite(THIS,0,1);
	/*
	//ROLLING BALL
	if (data->state == 1){
		//Tile detector
		data->tile = GetScrollTile((THIS->x + 8), (THIS->y + 8));
		...
		if((data->col == 1)||(data->col == 2)||(data->col == 3)||(data->col == 4)||(data->col == 5)||(data->col == 6)||(data->col ==38)||(data->col == 39)){
		...
		if((data->col == 1)||(data->col == 2)||(data->col == 3)||(data->col == 4)||(data->col == 7)||(data->col == 8)||(data->col == 36)||(data->col == 37)){
	...
	if (data->state == 0){
		...
		if(HitDir == 32) HitDir = 0;
		if(HitDir == -2) HitDir = 30;
